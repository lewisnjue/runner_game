""" 
LETS TALK HOW VIDEO GAMES WORK , IN A MOVIE , NO WAY TO IMPUT 
(EXCEPT PAUSING AND FAST FORWARDING ), 
GAMES : CONSTANT CHECKING OF PLAYER INPUT TO UPDATE WHAT FRAME 
IS BEING DRAWN 
...
GROUND_SURF = pygame.image.load(os.path.join('graphics','ground.png')).convert()
#TEXT_SURF = FONT.render('MY GAME ',False,(64,64,64))
SNAIL_WALK_1 = pygame.image.load(os.path.join('graphics','snail','snail1.png')).convert_alpha()
SNAIL_WALK_2 = pygame.image.load(os.path.join('graphics','snail','snail2.png')).convert_alpha()
SNAIL_WALK_LIST = [SNAIL_WALK_1,SNAIL_WALK_2]
SNAIL_WALK_INDEX = 0
JUMP_SOUND = pygame.mixer.Sound('audio/jump.mp3')
JUMP_SOUND.set_volume(0.5)
PLAY_SOUND = pygame.mixer.Sound('audio/music.wav')
...
PLAYER_JUMP = pygame.image.load(os.path.join('graphics','Player','jump.png'))
...
fly_surf_1 = pygame.image.load('graphics/Fly/Fly1.png')
fly_surf_2 = pygame.image.load('graphics/Fly/Fly2.png')
...
obstacle_rect_list = []
# player stand 
PLAYER_STAND_IMPORT = pygame.image.load(os.path.join('graphics','Player','player_stand.png')).convert_alpha()
...
while True:
 ...
 #       SCREEN.blit(TEXT_SURF,TEXT_RECT)
        ...
        game_messange = FONT.render('press sapce to run',False,(111,196,169))
...
""" 
REACTANGLES 
. rectangles help pricise positioning of surfaces 
. basic collisons 
